...
namespace zakjr.Data.Migrations
{
    ...
    [Migration("20170411024058_ContentChunkSubclasses")]
    partial class ContentChunkSubclasses
    {
            ...
            modelBuilder.Entity("zakjr.Models.ContentChunk", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ContentChunk");
                });

            modelBuilder.Entity("zakjr.Models.CodeContentChunk", b =>
                {
                    b.HasBaseType("zakjr.Models.ContentChunk");
                    ...
                    b.ToTable("CodeContentChunk");

                    b.HasDiscriminator().HasValue("CodeContentChunk");
                });
            ...
            modelBuilder.Entity("zakjr.Models.ImageContentChunk", b =>
                {
                    ...
                    b.ToTable("ImageContentChunk");

                    b.HasDiscriminator().HasValue("ImageContentChunk");
                });
            ...
            modelBuilder.Entity("zakjr.Models.TextContentChunk", b =>
                {
                    ...
                    b.ToTable("TextContentChunk");

                    b.HasDiscriminator().HasValue("TextContentChunk");
                });
            ...
            modelBuilder.Entity("zakjr.Models.VideoContentChunk", b =>
                {
                    ...
                    b.ToTable("VideoContentChunk");

                    b.HasDiscriminator().HasValue("VideoContentChunk");
                });
